...
const NewPassword: FC = () => {
  ...
  return (
    <div
      ...
      data-cy="authentication-new-password-container"
    >
      <div
        className="flex justify-center items-center w-[80%] md:w-[35%] "
        data-cy="authentication-new-password-form-wrapper"
      >
        <div
          className="flex flex-col items-center gap-8 w-[80%] "
          data-cy="authentication-new-password-form-container"
        >
          <div
            className="flex flex-row items-center gap-8"
            data-cy="authentication-new-password-logo"
          >
            <Logo type="selamnew" />
          </div>
          ...
          <div
            ...
            data-cy="authentication-new-password-title-section"
          >
            <h2
              className="text-2xl font-semibold"
              data-cy="authentication-new-password-title"
            >
              Create New Password
            </h2>
          </div>
