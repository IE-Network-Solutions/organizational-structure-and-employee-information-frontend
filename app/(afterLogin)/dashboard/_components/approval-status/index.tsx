...
const ApprovalStatus: FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center gap-2" data-cy="dashboard-approval-status-title-section">
        ...
        >
          ...
          <Button
            ...
            icon={approverType === 'Personal' ? <MdOutlineAssignmentInd /> : <MdOutlineGroups />}
            onClick={() => handleChange(approverType === 'Personal' ? "Leave" : "Personal")}
          >
