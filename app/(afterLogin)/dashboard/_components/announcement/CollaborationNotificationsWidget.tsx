        ...
        >
          ...
          {isCompose ? (
            <Button
              ...
              data-cy="dashboard-announce-back"
            >
              Back
            </Button>
          ) : (
            <Button
              ...
              data-cy="dashboard-announce-trigger"
            >
              Announce
            </Button>
          )}
        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                className="mt-2 border-t border-[#F0F0F0] pt-2"
                data-cy="collaboration-notifications-footer"
              >
                <a
                  href="#"
                  className="text-xs font-medium hover:underline"
                  style={{ color: collaborationColors.primary }}
                  data-cy="collaboration-notifications-open-link"
