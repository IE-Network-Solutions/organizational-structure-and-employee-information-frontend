...
export default function PepAuditPeriodCard({
  ...
  return (
    ...
    >
      <div className="border-b border-[#F0F0F0] p-4" data-cy="bsc-pep-audit-period-header">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="min-w-0 flex-1">
            <h2 className="m-0 text-xl font-bold text-gray-900">{scorecard.userName}</h2>
      ...
      <div data-cy="bsc-pep-audit-period-kpis">
        {targets.length ? (
          ...
          <p className="m-0 px-4 py-6 text-center text-sm text-gray-400">
