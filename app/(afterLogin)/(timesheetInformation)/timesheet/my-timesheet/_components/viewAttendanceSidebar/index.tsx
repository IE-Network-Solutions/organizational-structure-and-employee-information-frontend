    ...
    return (
      ...
      >
        {record.lateByMinutes > 0 && (
          ...
          >
            <span id="time-attendance-view-attendance-sidebar-late-by-label" data-cy="time-attendance-view-attendance-sidebar-late-by-label" className="font-bold">late by </span> &nbsp;
    ...
    return (
      ...
      >
        {record.earlyByMinutes > 0 && (
          ...
          >
            <span id="time-attendance-view-attendance-sidebar-early-by-label" data-cy="time-attendance-view-attendance-sidebar-early-by-label" className="font-bold">early by </span> &nbsp;
          ...
          <>
            ...
            >
              {attendance?.createdBy && (
                <Col data-cy="time-attendance-view-attendance-sidebar-employee-column" span={24}>
                  <div
                  ...
                  >
                    Employee
                    <span id="time-attendance-view-attendance-sidebar-employee-label-asterisk" data-cy="time-attendance-view-attendance-sidebar-employee-label-asterisk" className="text-error">*</span>
                  </div>
                  <div
                    className="pl-20"
              ...
              <Col data-cy="time-attendance-view-attendance-sidebar-date-column" span={24}>
                <div
                  className="text-sm text-gray-900 font-medium mb-2.5"
              ...
              <Col data-cy="time-attendance-view-attendance-sidebar-clock-in-column" span={12}>
                <div
              ...
              <Col data-cy="time-attendance-view-attendance-sidebar-clock-out-column" span={12}>
                <div
                  className="text-xs text-gray-900 font-medium mb-2.5"
              ...
              {attendance.attendanceBreaks.map((item, breakIndex) => (
                <React.Fragment key={item.id}>
                  <Col data-cy="time-attendance-view-attendance-sidebar-break-check-in-column" span={12}>
                    <div
                      className="text-sm text-gray-900 font-medium mb-2.5"
                  ...
                  <Col data-cy="time-attendance-view-attendance-sidebar-break-check-out-column" span={12}>
                    <div
                      className="text-sm text-gray-900 font-medium mb-2.5"
            ...
            >
              ...
              <Space data-cy="time-attendance-view-attendance-sidebar-status-badges">
                {formatToAttendanceStatuses(attendance).map((status, statusIndex) => (
                  <StatusBadge
                  ...
                  >
                    <div id={`time-attendance-view-attendance-sidebar-status-badge-${statusIndex}-div`} data-cy={`time-attendance-view-attendance-sidebar-status-badge-${statusIndex}-div`} className="text-center">
                      <div id={`time-attendance-view-attendance-sidebar-status-badge-${statusIndex}-status-div`} data-cy={`time-attendance-view-attendance-sidebar-status-badge-${statusIndex}-status-div`}>{status?.status}</div>
                      {status?.text && (
                        <div id={`time-attendance-view-attendance-sidebar-status-badge-${statusIndex}-text-div`} data-cy={`time-attendance-view-attendance-sidebar-status-badge-${statusIndex}-text-div`} className="font-normal">{status?.text}</div>
                      )}
                    </div>
                  </StatusBadge>
                ))}
            ...
            >
              <Col data-cy="time-attendance-view-attendance-sidebar-overtime-column" span={12}>
                <div
                  className="text-sm text-gray-900 font-medium mb-2.5"
              ...
              <Col data-cy="time-attendance-view-attendance-sidebar-total-time-column" span={12}>
                <div
                  className="text-sm text-gray-900 font-medium mb-2.5"
            ...
            {attendance.import && (
              <div id="time-attendance-view-attendance-sidebar-additional-information-container" data-cy="time-attendance-view-attendance-sidebar-additional-information-container">
                <div id="time-attendance-view-attendance-sidebar-additional-information-label" data-cy="time-attendance-view-attendance-sidebar-additional-information-label" className="text-center text-base font-semibold text-gray-900 mb-6">
                  Additional information
                </div>

                <div id="time-attendance-view-attendance-sidebar-additional-information-imported-by-container" data-cy="time-attendance-view-attendance-sidebar-additional-information-imported-by-container"   className="mb-6">
                  <div id="time-attendance-view-attendance-sidebar-additional-information-imported-by-label" data-cy="time-attendance-view-attendance-sidebar-additional-information-imported-by-label" className="text-sm text-gray-900 font-medium mb-2.5">
                    Imported by <span id="time-attendance-view-attendance-sidebar-additional-information-imported-by-label-asterisk" data-cy="time-attendance-view-attendance-sidebar-additional-information-imported-by-label-asterisk" className="text-error">*</span>
                  </div>

                  <UserCard data-cy="time-attendance-view-attendance-sidebar-additional-information-imported-by-card"
                    data={userData}
                    name={
                      userData?.firstName +
                      ' ' +
                ...
                <div>
                  <div id="time-attendance-view-attendance-sidebar-additional-information-imported-date-label" data-cy="time-attendance-view-attendance-sidebar-additional-information-imported-date-label" className="text-sm text-gray-900 font-medium mb-2.5">
                    Imported date <span id="time-attendance-view-attendance-sidebar-additional-information-imported-date-label-asterisk" data-cy="time-attendance-view-attendance-sidebar-additional-information-imported-date-label-asterisk" className="text-error">*</span>
                  </div>

                  <InfoItem data-cy="time-attendance-view-attendance-sidebar-additional-information-imported-date-item" size="large" value="23 Mar 2023" />
                </div>
              </div>
            )}
          </>
