...
const MySchedulePage = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="hidden sm:block px-4 pb-3"
        data-cy="time-attendance-my-schedule-desktop-filter-container"
      >
        <div
          className="flex w-full min-w-0 flex-nowrap items-center justify-between gap-8 lg:gap-12"
          data-cy="time-attendance-my-schedule-desktop-filter-row"
        >
          <div
            className="min-w-0 shrink"
            data-cy="time-attendance-my-schedule-desktop-filter-filters"
          >
      ...
      <div
        ...
        data-cy="time-attendance-my-schedule-mobile-filter-container"
      >
        <ScheduleTableFilter value={weekFilter} onChange={setWeekFilter} />
      </div>
