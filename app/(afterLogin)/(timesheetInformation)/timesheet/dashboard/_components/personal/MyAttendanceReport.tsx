    ...
    return (
        <Card className="shadow">
            ...
            <div className='flex flex-col h-48 overflow-y-auto scrollbar-none'>
                ...
                {[
                    { type: 'Annual Leave', date: '1-20 Jun 2025', status: 'late', time: "7:45 AM" },
                    { type: 'Sick Leave', date: '1-20 Jun 2025', status: 'on time', time: "7:10 AM" },
                    { type: 'Unpaid Leave', date: '1-20 Jun 2025', status: 'absent', time: "" },
                    { type: 'Unpaid Leave', date: '1-20 Jun 2025', status: 'absent', time: "" },
                ].map((req, index) => (
                    <div key={index} className="mb-2 border p-4 rounded-md">
                        <div className="flex justify-between items-center">
                            ...
                            <div className='flex flex-col justify-end items-end'>
                                <Tag style={{ marginInlineEnd: 0, border: "none" }} className={` capitalize ${req.status === 'on time'
