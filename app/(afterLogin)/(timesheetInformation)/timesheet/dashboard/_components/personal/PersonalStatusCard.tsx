...
const PersonalStatusCard: React.FC = () => {
    const statsData: StatData[] = [
        { title: 'Total Leave Days', value: '206', icon: <CiCalendarDate className='text-blue' />, color: ' text-purple-600' },
        { title: 'Pending Request', value: '8', icon: <IoTimeOutline className='text-blue' />, color: 'text-blue-600' },
        { title: 'Approved Leave', value: '32', icon: <CiCalendarDate className='text-blue' />, color: ' text-black' },
        { title: 'Total Late arrival', value: '2', icon: <AiOutlineInfoCircle className='text-blue' />, color: 'text-yellow-400' },
        { title: 'Absentism', value: '10', icon: <GoQuestion className='text-blue' />, color: ' text-red-600' },
    ];
