                      ...
                      <div>
                        ...
                        <span
                          className={`text-xs px-2 py-0.5 rounded-full font-medium truncate ${
                            item.leaveType?.includes('Planned Annual Leave')
                              ? 'bg-violet-200 text-violet-800'
                              : item.leaveType?.includes('Sick')
                                ? 'bg-yellow-100 text-yellow-700'
                                : item.leaveType?.includes('Emergency Annual')
                                  ? 'bg-green-100 text-green-700'
                                  : item.leaveType?.includes('Maternity')
                                    ? 'bg-indigo-100 text-indigo-700'
                                    : item.leaveType?.includes('Unpaid')
                                      ? 'bg-red-100 text-red-700'
                                      : item.leaveType?.includes('Paternity')
