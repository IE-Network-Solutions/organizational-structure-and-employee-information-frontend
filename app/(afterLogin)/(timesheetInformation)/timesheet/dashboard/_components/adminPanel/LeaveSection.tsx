...
const LeaveSection: React.FC = () => {
  const leaveData: LeaveData[] = [
    {
      name: 'Hanna Baptista',
      period: '26 Feb 2025 to 30 Feb 2025',
      days: '5 Days',
      type: 'Annual Leave',
      avatar: 'HB',
    },
      ...
      <div className="grid grid-cols-12 gap-4 items-start">
        <div className="space-y-3 mb-4 col-span-5">
          <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
            ...
            <Select defaultValue="Department" className="w-full  h-12">
            ...
            {leaveData.map((leave, index) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <Avatar className="bg-purple-500 w-4 h-4">
                    {leave.avatar}
                  </Avatar>
                  <div>
        ...
        <div className="h-64 w-full  col-span-7">
          <div className="flex flex-col sm:flex-row justify-between items-end mb-4 gap-4 w-full">
            <p className="text-purple-600 text-[12px] flex items-center gap-2">
              ...
              Number of Employees on leave: 108
            </p>
