          ...
          {isLoadingTeamLead ? (
            ...
            <>
              <Tooltip title={department.name} placement="top">
                <p className="text-base font-bold text-gray-800 m-0 mb-0.5 truncate" data-cy={`transfer-team-card-name-${department.id}`}>
                  {department.name}
                </p>
              </Tooltip>
              <p className="text-xs text-gray-500 m-0 truncate" data-cy={`transfer-team-card-lead-${department.id}`}>
                Not assigned
              </p>
            </>
          ) : (
            <>
              ...
              <p className="text-xs text-gray-600 m-0 truncate" data-cy={`transfer-team-card-lead-${department.id}`}>
                {teamLeadName}
              </p>
            </>
          )}
