...
const MergeButton: React.FC<MergeButtonProps> = ({
  ...
  return (
    <div 
      ...
      data-cy={isMobile ? "merge-action-container-mobile" : "merge-action-container"}
    >
      <Button
        type="default"
        onClick={onClick}
        ...
        data-cy={isMobile ? "org-settings-merge-submit-btn-mobile" : "org-settings-merge-submit-btn"}
        id={isMobile ? "org-settings-merge-submit-btn-mobile" : "org-settings-merge-submit-btn"}
      >
        <span className={hasItemsInBuckets ? 'text-white' : textColorClass}>Merge</span>
      </Button>
    </div>
  );
};
