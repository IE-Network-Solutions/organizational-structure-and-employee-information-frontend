  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Source Box - Mobile */}
        <div
          className="w-full max-w-[350px] relative z-10 flex flex-col items-center"
          data-cy="merge-source-teams-panel"
        >
          <div
            ref={sourceBoxRef}
            className={`border-2 rounded-lg p-4 bg-gray-50 w-full flex flex-col justify-center ${
              sourceTeam || isSourceOver
                ? 'border-solid border-primary'
                : 'border-spacing-1 border-dashed border-gray-200'
            }`}
        ...
        <div
          className="w-full max-w-[350px] relative z-10 flex flex-col items-center"
          data-cy="merge-destination-panel"
        >
          <div
