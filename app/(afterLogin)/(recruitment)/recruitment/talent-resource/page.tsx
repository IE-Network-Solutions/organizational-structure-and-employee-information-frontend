      ...
      >
        ...
        >
          ...
          <div
            ...
            className="flex items-center bg-[#f5f5f5] shadow-md rounded-lg w-fit h-8 sm:h-16  gap-4 sm:gap-12 mx-3 sm:mx-0"
          >
            <button
            ...
            >
              <span
                ...
                data-cy="talent-acquisition-talent-resource-page-tab-talent-roster-label"
                className="text-xs sm:text-sm text-nowrap"
              >
                Talent Roster
              </span>
            ...
            >
              <span
                data-cy="talent-acquisition-talent-resource-page-tab-intern-label"
                className="text-xs sm:text-sm text-nowrap"
              >
                Intern
              </span>
        ...
        <div
          ...
          className="w-full h-auto bg-white rounded-lg p-6 shadow mt-4"
        >
