    ...
    shareModalOpen && (
      ...
      >
        ...
        <div className="flex items-center justify-start gap-5 p-2 py-2">
          <FaXTwitter id="talent-acquisition-share-icon-twitter" data-cy="talent-acquisition-share-icon-twitter" size={35} />
          <FaFacebook id="talent-acquisition-share-icon-facebook" data-cy="talent-acquisition-share-icon-facebook" size={35} color="#0866FF" />
          <FaLinkedin id="talent-acquisition-share-icon-linkedin" data-cy="talent-acquisition-share-icon-linkedin" size={35} color="#0A66C2" />
          <FaTelegram id="talent-acquisition-share-icon-telegram" data-cy="talent-acquisition-share-icon-telegram" size={35} color="#2AABEE" />
          <FaWhatsapp id="talent-acquisition-share-icon-whatsapp" data-cy="talent-acquisition-share-icon-whatsapp" size={35} color="#25D366" />
        </div>
        <div className="flex items-center justify-center gap-3 border-[1px] p-2 rounded-md">
          ...
          <div id="talent-acquisition-share-button-copy" data-cy="talent-acquisition-share-button-copy" onClick={handleCopy}>
            {isChecked ? (
              <CheckCheck
                size={16}
                strokeWidth={1.75}
