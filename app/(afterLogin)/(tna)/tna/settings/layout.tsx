...
const TnaSettingsLayout: FC<TnaSettingsLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] p-3" id="tnaSettingsLayoutId" data-cy="tna-settings-layout">
      <div className="h-auto w-auto" id="tnaSettingsLayoutContentId" data-cy="tna-settings-layout-content">
        <PageHeader
          title="Settings"
        ...
        <div className="flex flex-col lg:flex-row gap-6 mt-3" id="tnaSettingsLayoutBodyId" data-cy="tna-settings-layout-body">
          <SidebarMenu menuItems={menuItems} data-cy="tna-settings-layout-sidebar" />

          <BlockWrapper className="flex-1 h-max overflow-x-auto bg-[#fafafa] p-0" data-cy="tna-settings-layout-block-wrapper">
            {children}
          </BlockWrapper>
        </div>
      </div>
