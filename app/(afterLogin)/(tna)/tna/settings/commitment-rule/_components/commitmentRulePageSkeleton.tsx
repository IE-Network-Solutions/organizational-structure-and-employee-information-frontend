    ...
    >
      ...
      >
        {Array.from({ length: CARD_COUNT }).map((unusedValue, idx) => (
          ...
          >
            <div
              className="flex items-center justify-between gap-3 px-4 py-4 border-b border-gray-200"
              data-cy={`tna-commitment-rule-skeleton-card-body-${idx}`}
            >
              <Skeleton.Input
                active
                size="small"
              ...
              <div
                ...
                data-cy={`tna-commitment-rule-skeleton-card-controls-${idx}`}
              >
