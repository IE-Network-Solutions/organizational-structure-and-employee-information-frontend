...
const ReprimandDrawer: React.FC<RepDrawerProps> = ({
  ...
  const customTagRender = (props: any) => {
    ...
    return (
      <div
        ...
        data-cy="reprimand-drawer-tag-container"
      >
        <Avatar size={20} icon={<UserOutlined />} />
        <span data-cy="reprimand-drawer-tag-label">{label}</span>
        {closable && (
          <span
            onClick={onClose}
            className="text-black text-xs"
            data-cy="reprimand-drawer-tag-close"
          >
            ✖
          </span>
        )}
  ...
  const modalHeader = (
    <div
      ...
      data-cy="reprimand-drawer-modal-header"
    >
      Reprimand
    </div>
  );
  const footer = (
    <div
      ...
      data-cy="reprimand-drawer-footer"
    >
      <CustomButton
        type="default"
        title="Cancel"
