  ...
  return (
    ...
    >
      ...
      >
                ...
                >
                  ...
                  >
                    <Select
                      ...
                      data-cy={`okr-numeric-desktop-advanced-type-select-${index}`}
        ...
        {/* Mobile Layout: card view when saved, form when editing (same UI as Currency) */}
        {isMobile && (
          <>
            {isCardView ? (
              <div
                  ...
                  >
                    ...
                    <Tooltip title="Edit">
                      <button
                        ...
                        data-cy={`okr-numeric-mobile-saved-card-${index}-edit`}
                      >
              ...
              >
                ...
                >
                  ...
                  >
                    <InputNumber
                      className="w-full h-10 rounded-lg text-base"
                      data-cy={`okr-numeric-mobile-target-input-${index}`}
                      min={0}
                      placeholder="Target Value"
                      value={keyItem.targetValue ?? 0}
                      onChange={(value) =>
