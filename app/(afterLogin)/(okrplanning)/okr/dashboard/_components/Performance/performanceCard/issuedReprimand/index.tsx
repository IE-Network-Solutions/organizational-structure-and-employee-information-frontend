      ...
      >
        ...
        >
          <rect
            ...
            fill="#FF782D"
            fillOpacity="0.2"
            data-cy="okr-issued-reprimand-icon-rect"
          />
          <g
            clip-path="url(#clip0_7606_452751)"
            data-cy="okr-issued-reprimand-icon-group"
          >
            <path
              ...
              fill="#E03137"
              data-cy="okr-issued-reprimand-icon-path"
            />
          </g>
          <defs data-cy="performance-performancecard-issuedreprimand-index-tsx-index-defs-48">
            <clipPath
            ...
            >
              <rect
                ...
                data-cy="okr-issued-reprimand-clip-rect"
              />
            </clipPath>
          </defs>
        </svg>
