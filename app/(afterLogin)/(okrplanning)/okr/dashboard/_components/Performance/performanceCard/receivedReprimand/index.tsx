...
const ReceivedReprimand: React.FC<{ kpi: number; engagement: number }> = ({
  kpi,
  engagement,
}) => {
  return (
      ...
      >
        ...
        >
          <rect
            ...
            fill="#FF782D"
            fillOpacity="0.2"
            data-cy="okr-received-reprimand-icon-rect"
          />
          <g
            clip-path="url(#clip0_7606_452751)"
            data-cy="okr-received-reprimand-icon-group"
          >
            <path
              ...
              fill="#E03137"
              data-cy="okr-received-reprimand-icon-path"
            />
          </g>
          <defs data-cy="performance-performancecard-receivedreprimand-index-tsx-index-defs-49">
            <clipPath
            ...
            >
              <rect
                ...
                data-cy="okr-received-reprimand-clip-rect"
              />
            </clipPath>
          </defs>
        </svg>
