              ...
              >
                ...
                >
                  <path
                    ...
                    fill="#3636F0"
                    data-cy="import-drawer-svg-path-1"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    ...
                    fill="#1D9BF0"
                    data-cy="import-drawer-svg-path-2"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    ...
                    fill="white"
                    data-cy="import-drawer-svg-path-3"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    ...
                    fill="white"
                    data-cy="import-drawer-svg-path-4"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    ...
                    fill="white"
                    data-cy="import-drawer-svg-path-5"
                  />
                  <path
                    ...
                    fill="white"
                    data-cy="import-drawer-svg-path-6"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-7"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    ...
                    fill="#6666FF"
                    data-cy="import-drawer-svg-path-8"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    ...
                    fill="#6666FF"
                    data-cy="import-drawer-svg-path-9"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    ...
                    fill="#2B2BBD"
                    data-cy="import-drawer-svg-path-10"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    ...
                    fill="#2B2BBD"
                    data-cy="import-drawer-svg-path-11"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    ...
                    fill="#3636F0"
                    data-cy="import-drawer-svg-path-12"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    ...
                    fill="#3636F0"
                    data-cy="import-drawer-svg-path-13"
                  />
                  <path
                    ...
                    fill="#B2B2FF"
                    data-cy="import-drawer-svg-path-14"
                  />
                  <path
                    ...
                    fill="#B2B2FF"
                    data-cy="import-drawer-svg-path-15"
                  />
                  <path
                    ...
                    fill="#B2B2FF"
                    data-cy="import-drawer-svg-path-16"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-17"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-18"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-19"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-20"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-21"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-22"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-23"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-24"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-25"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-26"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-27"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-28"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-29"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-30"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-31"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-32"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-33"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-34"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-35"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-36"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-37"
                  />
                  <path
                    ...
                    fill="#111827"
                    data-cy="import-drawer-svg-path-38"
                  />
                </svg>
              </p>
              <p
