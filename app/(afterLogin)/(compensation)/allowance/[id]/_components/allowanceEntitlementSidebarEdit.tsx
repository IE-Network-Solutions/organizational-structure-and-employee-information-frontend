...
type AllowanceEntitlementSideBarEditProps = {
  title: string;
};

const AllowanceEntitlementSideBarEdit = ({
  title,
}: AllowanceEntitlementSideBarEditProps) => {
  void title;
  const {
  ...
  const { mutate: updateAllowanceEntitlement, isLoading: updateLoading } =
  ...
  useEffect(() => {
    if (!employeeEntitlementData || isLoading) return;
    ...
    <Modal
      title={
        <div
          ...
          data-cy="compensation-allowance-sidebar-edit-modal-title-row"
        >
          <span
            className="inline-flex min-h-6 items-center text-base font-semibold leading-6 text-gray-900"
            id="compensation-allowance-sidebar-edit-title"
            data-cy="compensation-allowance-sidebar-edit-title"
          >
            Edit Allowance Entitlement
          </span>
          <button
            type="button"
            onClick={onClose}
            ...
            data-cy="compensation-allowance-sidebar-edit-close"
          >
      ...
      footer={
        <div
          ...
          id="compensation-allowance-sidebar-edit-footer"
          data-cy="compensation-allowance-sidebar-edit-footer"
        >
          <Button
            type="default"
            ...
            onClick={onClose}
            id="compensation-allowance-sidebar-edit-cancel-button"
            data-cy="compensation-allowance-sidebar-edit-cancel-button"
          >
            Cancel
          </Button>
          <Button
            ...
            loading={updateLoading}
            onClick={() => form.submit()}
            id="compensation-allowance-sidebar-edit-update-button"
            data-cy="compensation-allowance-sidebar-edit-update-button"
          >
            Edit
          </Button>
        </div>
      ...
      data-cy="compensation-allowance-edit-entitlement-modal"
    >
      <div
        className="rounded-lg border border-solid border-[#D9D9D9] bg-white px-6 py-5"
        data-cy="compensation-allowance-sidebar-edit-modal-inner"
      >
        <Spin
          spinning={allUserLoading || payLoading || isLoading}
          data-cy="compensation-allowance-sidebar-edit-spin"
        >
          <Form
            layout="vertical"
            form={form}
            ...
            id="compensation-allowance-sidebar-edit-form"
            data-cy="compensation-allowance-sidebar-edit-form"
          ...
          >
            <div
              ...
              id="compensation-allowance-sidebar-edit-grid"
              data-cy="compensation-allowance-sidebar-edit-grid"
            >
              <Form.Item
                data-cy="compensation-allowance-sidebar-edit-total-amount-item"
                label="Total Amount"
                className="mb-0"
                required
                rules={[
              ...
              >
                <InputNumber
                  ...
                  disabled
                  id="compensation-allowance-sidebar-edit-total-input"
                  data-cy="compensation-allowance-sidebar-edit-total-input"
                />
              </Form.Item>
              <Form.Item
                data-cy="compensation-allowance-sidebar-edit-pay-period-item"
                label="Pay Period"
                className="mb-0"
                required
              ...
              >
                <InputNumber
                  ...
                  id="compensation-allowance-sidebar-edit-settlement-input"
                  data-cy="compensation-allowance-sidebar-edit-settlement-input"
                />
              </Form.Item>
            </div>
            ...
            {editPaymentsData?.length > 0 && (
              <div
                ...
                id="compensation-allowance-sidebar-edit-table-wrapper"
                data-cy="compensation-allowance-sidebar-edit-table-wrapper"
              >
                {editPaymentsData.map((record: any, index: number) => {
                  ...
                  return (
                    <div
                      ...
                      data-cy={`compensation-allowance-sidebar-edit-payment-row-${index}`}
                    >
                      <Form.Item
                        label="Amount"
            ...
            <Form.Item
              ...
              required
              id="compensation-allowance-sidebar-edit-employee-item"
              data-cy="compensation-allowance-sidebar-edit-employee-item"
              className="mb-0"
            >
              <div data-cy="compensation-allowance-sidebar-edit-employee-field-wrap">
                <div
                  ...
                  id="compensation-allowance-sidebar-edit-employee-select"
                  data-cy="compensation-allowance-sidebar-edit-employee-select"
                >
                  <span data-cy="compensation-allowance-sidebar-edit-employee-placeholder">
                    Select employee
                  </span>
                ...
                <div
                  ...
                  id="compensation-allowance-sidebar-edit-employee-tags"
                  data-cy="compensation-allowance-sidebar-edit-employee-tags"
                >
                  {(() => {
...
export default AllowanceEntitlementSideBarEdit;
