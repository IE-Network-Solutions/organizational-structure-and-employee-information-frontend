...
import { MdKeyboardArrowDown, MdKeyboardArrowUp, MdAdd, MdEdit, MdDelete } from 'react-icons/md';
        ...
        <Card
          ...
          extra={
            <Space>
              ...
              <Button htmlType='button' type='primary' icon={<MdEdit />} size="small" />
          ...
          {!collapseStates[index] && (
           ...
           <div className="flex w-full">
             <div className="w-1/3 flex flex-col">
               <div className="text-gray-500 font-semibold mb-2">Responsible Person</div>
