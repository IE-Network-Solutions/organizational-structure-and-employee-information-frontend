    ...
    <>
      {isLoading ? (
        ...
        >
          ...
          >
            <Table
              ...
              columns={columns}
              pagination={false}
              data-cy="employee-score-card-table"
              id="employeeScoreCardTable"
            />
          </Card>
          <Card
            bodyStyle={{ padding: 0 }}
            className="p-4 border-none text-sm"
            data-cy="employee-score-card-score-card"
            id="employeeScoreCardScoreCard"
          >
            <p
              className="font-semibold mb-2"
              data-cy="employee-score-card-score-label"
              id="employeeScoreCardScoreLabel"
            >
              Score
            </p>
            {data.map((item: any) => (
              <p
                key={item.id}
                data-cy={`employee-score-card-item-${item.id}`}
                id={`employeeScoreCardItem${item.id}`}
              >
            ...
            <p
              ...
              data-cy="employee-score-card-total"
              id="employeeScoreCardTotal"
            >
        ...
        <div
          ...
          data-cy="employee-score-card-empty"
          id="employeeScoreCardEmpty"
        >
          {' '}
