...
const Page = () => {
    ...
    () => [
      {
        ...
        label: isMobile ? (
          ...
          >
            ...
            <span className="rounded-md border border-gray-200 bg-gray-50 px-2 py-0.5 text-xs font-medium tabular-nums text-gray-700">
              {getAppreciationFeedbackTypesByVariant?.meta?.totalItems ?? 0}
            </span>
          </div>
        ) : (
          <div
            className={`flex min-w-80 gap-4 rounded-lg border-[1px] p-3 transition-colors ${
              settingActiveTab === 'appreciation'
  ...
  return (
    <div
      ...
      className={isMobile ? 'max-md:-mx-1' : undefined}
    >
      <Tabs
        ...
        className={[
          '[&_.ant-tabs-tab]:border-none [&_.ant-tabs-tab]:bg-transparent [&_.ant-tabs-tab]:shadow-none [&_.ant-tabs-tab-active]:bg-white',
          isMobile
            ? [
                '[&_.ant-tabs-nav]:mb-3 [&_.ant-tabs-nav]:px-0',
