...
import DefineMeetingTypeSkeleton from './_components/defineMeetingTypeSkeleton';
...
const DefineMeetingType = () => {
  ...
  const listItems = meetingTypes?.items ?? [];

  const openCreateMeetingType = () => {
    setMeetingType(null);
    setOpen(true);
  };
        ...
        {isLoading ? (
          ...
          >
            <EmptyState
              ...
              description="Create a meeting type to use when scheduling CFR conversations."
              actionText="Add meeting type"
              onAction={openCreateMeetingType}
            />
          </div>
        ) : (
          <div
          ...
          >
            ...
            {meetingTypes?.meta && listItems.length > 0 && (
              <CustomPagination
                current={currentType}
