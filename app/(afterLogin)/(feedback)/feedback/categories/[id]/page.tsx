    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <FormDrawer onClose={onClose} id={id} data-cy="category-form-page-form-drawer" />
        </div>
        <div id="category-form-page-list" data-cy="category-form-page-list" className="w-full h-auto">
