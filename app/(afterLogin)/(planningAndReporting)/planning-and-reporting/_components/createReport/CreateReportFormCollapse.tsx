    ...
    return (
      ...
      >
        <Row gutter={[12, 12]} align="middle">
          ...
          >
            <p
              data-cy={`planning-and-reporting-createreportformcollapse-task-name-${task.taskId}`}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <div
                      data-cy={`create-report-status-done-box-${task.taskId}`}
                  ...
                  >
                    <div
                      data-cy={`create-report-status-not-box-${task.taskId}`}
            ...
            <Collapse.Panel
              ...
              header={
                ...
                >
                  ...
                  <span
                    data-cy={`create-report-panel-kr-title-${objective.id || 'obj'}-${index}`}
