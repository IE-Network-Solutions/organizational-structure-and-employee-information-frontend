...
const priorityOptions = [
  {
    ...
    label: (
      <span
        data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L131"
  ...
  },
  {
    ...
    label: (
      <span
        data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L135"
  ...
  },
  {
    ...
    label: (
      <span
        data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L139"
...
function OutcomeTaskListIcon({ line }: { line: DraftLine }) {
  ...
  return (
    <div
      data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L233"
...
function OutcomeTaskCheckboxRow({
  ...
  return (
    <div
      data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L256"
      className="flex items-center gap-1.5"
    >
      <Checkbox checked={checked} onChange={(e) => onToggle(e.target.checked)}>
        <span
          data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L258"
      ...
      <Tooltip title={outcomeAsTaskTooltip(milestoneId)} placement="topLeft">
        <span
          data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L263"
...
const INLINE_KEY_RESULT_INSTRUCTION = (
  <>
    <span
      data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L278"
      className="lg:hidden"
    >
      Click the{' '}
      <span
        data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L279"
    ...
    <span
      data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L282"
      className="hidden lg:inline"
    >
      Click the{' '}
      <span
        data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L283"
        className="font-semibold text-[#1E40AF]"
      >
        +
      </span>{' '}
...
>(function InlinePlanningWorkspace(
  ...
  return (
    ...
    >
      ...
      >
        <div
          data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L872"
        ...
        >
          <div
            data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L873"
          ...
          >
            ...
            <span
              data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L885"
          ...
          <div
            data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L889"
            className="flex min-w-0 flex-shrink-0 flex-wrap items-center justify-end gap-1.5 sm:gap-2 md:gap-3"
          >
            <span
              data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L890"
              className="whitespace-nowrap text-[12px] tabular-nums text-[#475569] md:text-sm"
            >
              {draftLines.length} task{draftLines.length !== 1 ? 's' : ''}
              <span
                data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L892"
                className="mx-1 text-[#CBD5E1] md:mx-2"
              >
                ·
              </span>
              <span
                data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L893"
                className={`font-bold ${weightTone}`}
              >
                {roundedTotal}
              </span>
              <span
                data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L894"
        ...
        <div
          data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L937"
          className="min-w-0"
        >
          ...
          {showEmptyInstruction ? (
            ...
            >
              <p
                data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-p-L947"
          ...
          !loadingEditPlan ? (
            <div
              data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L957"
              className={`space-y-4 px-3 py-3 md:px-5 md:py-5 ${
                draftLines.length > 0 ? 'border-b border-[#F1F2F6]' : ''
              }`}
            >
              <div
                data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L962"
                className="flex items-center justify-between gap-3 md:items-start"
              >
                <div
                  data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L963"
                  className="min-w-0 flex-1"
                >
                  <p
                    data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-p-L964"
                    className="text-[10px] font-semibold uppercase tracking-wider text-[#8F94A3]"
                  >
                    Adding to
                  </p>
                  <p
                    data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-p-L967"
                ...
                <button
                  data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-button-L972"
                  type="button"
              ...
              <div
                data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L982"
                className="rounded-lg border border-[#F1F2F6] bg-[#FAFBFC]/60 p-4"
              >
                <div
                  data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L983"
                  className="space-y-4"
                >
                  <Input
                    value={task}
                  ...
                  <div
                    data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L1005"
                    className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between lg:gap-5"
                  >
                    <div
                      data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L1006"
          ...
          !editingDraftId ? (
            <div
              data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L1047"
            ...
            >
              <p
                data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-p-L1054"
                className="text-[13px] leading-relaxed text-[#575B7A]"
              >
                You’ve reached{' '}
                <span
                  data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L1056"
                ...
                <span
                  data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L1058"
                  className="font-semibold text-[#161A2C]"
                >
                  Save plan
                </span>
          ...
          {!activeTarget && draftLines.length > 0 ? (
            <div
              data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L1064"
              className="border-b border-[#F1F2F6] px-4 py-3 text-[13px] text-[#575B7A] md:px-5"
            >
              <span
                data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L1065"
                className="lg:hidden"
              >
                Use + above to pick a key result and add more tasks.
              </span>
              <span
                data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L1068"
                className="hidden lg:inline"
              >
          ...
          {showDraftAndSubmit ? (
            <ul
              data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-ul-L1075"
            ...
            >
              {draftLines.map((l) =>
                editingDraftId === l.id ? (
                  ...
                  >
                    <div
                      data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L1084"
                      className="flex min-w-0 items-start gap-3"
                    >
                      <OutcomeTaskListIcon line={l} />
                      <div
                        data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L1086"
                        className="flex min-w-0 flex-1 flex-col gap-3"
                      >
                        <p
                          data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-p-L1087"
                          className="text-[10px] font-semibold uppercase tracking-wider text-[#8F94A3]"
                        >
                          Edit task
                        </p>
                        <p
                          data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-p-L1090"
                          className="text-[12px] leading-relaxed text-[#575B7A]"
                        >
                          {l.label}
                        </p>
                        <div
                          data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L1093"
                          className="rounded-lg border border-[#F1F2F6] bg-[#FAFBFC]/60 p-4"
                        >
                          <div
                            data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L1094"
                            className="space-y-4"
                          >
                            <Input
                              value={task}
                            ...
                            <div
                              data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L1127"
                              className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between lg:gap-5"
                            >
                              <div
                                data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L1128"
                                className="grid min-w-0 flex-1 grid-cols-3 gap-2 sm:gap-3 [&>*]:min-w-0"
                              >
                                <Select
                                  placeholder="Priority"
                              ...
                              <div
                                data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L1151"
                  ...
                  <li
                    data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-li-L1174"
                    key={l.id}
                  ...
                  >
                    <OutcomeTaskListIcon line={l} />
                    <div
                      data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L1179"
                      className="flex min-w-0 flex-1 flex-col gap-2"
                    >
                      <div
                        data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L1180"
                        className="flex items-start justify-between gap-3"
                      >
                        <div
                          data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L1181"
                          className="min-w-0 flex-1"
                        >
                          <p
                            data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-p-L1182"
                            className="text-[14px] font-semibold leading-snug text-[#161A2C] line-clamp-2"
                          >
                            {l.task}
                          </p>
                          <p
                            data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-p-L1185"
                        ...
                        <div
                          data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L1189"
                          className="flex flex-shrink-0 items-start gap-0.5"
                        >
                          <button
                            data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-button-L1190"
                            type="button"
                          ...
                          <button
                            data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-button-L1198"
                            type="button"
                      ...
                      <div
                        data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-div-L1208"
                        className="flex flex-wrap items-center gap-2"
                      >
                        <span
                          data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L1209"
                        ...
                        <span
                          data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L1214"
                        ...
                        <span
                          data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L1217"
                        ...
                        >
                          <span
                            data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-planning-inlineplanningworkspace-tsx-span-L1218"
