...
function TaskRowSkeleton({
  ...
  return (
    ...
    >
      <div className="h-[18px] w-[18px] rounded-[5px] bg-[#F1F2F6] flex-shrink-0" />
      <div className={`h-3 ${width} bg-[#F1F2F6] rounded`} />
      <div className="flex items-center flex-shrink-0 ml-auto gap-3">
        <div className="h-3 w-10 bg-[#F1F2F6] rounded-full" />
        <div className="h-3 w-5 bg-[#F1F2F6] rounded" />
        <div className="h-3 w-5 bg-[#F1F2F6] rounded" />
      </div>
    </div>
  );
...
export default function PlanCardSkeleton({
  ...
  return (
    <div className="rounded-xl border border-[#F1F2F6] bg-white animate-pulse overflow-hidden">
      {/* Header */}
      <div
        className={
      ...
      >
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-3 flex-1 min-w-0">
            <div className="h-9 w-9 rounded-full bg-[#F1F2F6] flex-shrink-0" />
            <div className="flex flex-col gap-1.5 min-w-0 flex-1">
              <div className="h-3.5 w-28 bg-[#F1F2F6] rounded" />
              <div className="h-2.5 w-20 bg-[#F1F2F6] rounded" />
            </div>
          </div>
          <div className="h-5 w-16 bg-[#F1F2F6] rounded-full" />
        </div>
      </div>
      ...
      <div className="px-3 md:px-4">
        <div className="flex items-center px-2.5 pb-1 mb-0.5 mt-1">
          <div className="h-2.5 w-32 bg-[#F1F2F6] rounded" />
        </div>
      </div>

      {/* Task rows */}
      <div className={['px-3 md:px-4 space-y-[2px]', taskBlockPb].join(' ')}>
      ...
      >
        <div className="flex items-center gap-2">
          <div className="h-3 w-20 bg-[#F1F2F6] rounded" />
        </div>
      </div>
    </div>
  );
      ...
      {[1, 2, 3].map((i) => (
        ...
        >
          <div className="flex items-start gap-3">
            <div className="h-[18px] w-[18px] flex-shrink-0 rounded-[5px] bg-[#F1F2F6]" />
            <div className="flex min-w-0 flex-1 flex-col gap-2">
              ...
              />
              <div className="h-4 max-w-sm w-3/5 rounded bg-[#F1F2F6]" />
              <div className="flex flex-wrap items-center gap-2 pt-1">
                <div className="h-5 w-16 rounded-full bg-[#F1F2F6]" />
                <div className="h-5 w-12 rounded-full bg-[#F1F2F6]" />
                <div className="h-5 w-20 rounded-full bg-[#F1F2F6]" />
              </div>
            </div>
          </div>
        </li>
    ...
    <div className="flex flex-col h-full animate-pulse">
      ...
      <div className="bg-white border-b border-[#F1F2F6] px-4 py-3.5 flex-shrink-0">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="h-7 w-7 rounded-lg bg-[#F1F2F6]" />
            <div className="flex flex-col gap-1">
              <div className="h-3 w-20 bg-[#F1F2F6] rounded" />
              <div className="h-2 w-28 bg-[#F1F2F6] rounded" />
            </div>
          </div>
          <div className="h-5 w-8 bg-[#F1F2F6] rounded-lg" />
        </div>
      </div>
        ...
        {[1, 2, 3, 4].map((i) => (
          ...
          >
            <div className="flex items-start justify-between gap-2 mb-2">
              ...
              />
              <div className="h-4 w-10 bg-[#F1F2F6] rounded-md flex-shrink-0" />
            </div>
            <div className="h-[5px] w-full rounded-full bg-[#F1F2F6] mb-2" />
            <div className="h-2 w-16 bg-[#F1F2F6] rounded" />
          </div>
        ))}
      </div>
    </div>
