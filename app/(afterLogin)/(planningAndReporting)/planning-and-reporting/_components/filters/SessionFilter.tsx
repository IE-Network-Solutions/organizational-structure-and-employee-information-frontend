...
const selectClassName =
  'w-full min-w-[160px] flex-1 md:w-auto [&_.ant-select-selector]:!border-[#E3E6F5] [&_.ant-select-selector]:!rounded-lg [&_.ant-select-selector]:!bg-[#FFFFFF] [&_.ant-select-selector]:!py-1 [&_.ant-select-selector]:!px-3 [&_.ant-select-selector]:!min-h-[48px] [&_.ant-select-selector]:!h-12 [&_.ant-select-selector]:!items-center [&_.ant-select-selection-placeholder]:!text-[#7C82A7] [&_.ant-select-selection-placeholder]:!leading-7 [&_.ant-select-selection-placeholder]:!pt-0 [&_.ant-select-selection-item]:!text-[#1F2240] [&_.ant-select-selection-item]:!leading-7 [&_.ant-select-selection-item]:!pt-0 [&_.ant-select-selection-item]:!flex [&_.ant-select-selection-item]:!items-center [&_.ant-select-selection-overflow-item]:!flex [&_.ant-select-selection-overflow-item]:!items-center [&.ant-select]:!h-12 [&.ant-select-focused_.ant-select-selector]:!border-[#3636F0] [&.ant-select-focused_.ant-select-selector]:!shadow-[0_0_0_2px_rgba(54,54,240,0.1)] [&.ant-select-focused_.ant-select-selector]:!bg-[#FFFFFF] [&.ant-select-open_.ant-select-selector]:!bg-[#FFFFFF]';
