...
export default function TaskRow({
  ...
  const getStatusIcon = () => {
    if (viewMode === 'reporting') {
      ...
      return (
        <div
          data-cy="planning-taskrow-status-dot"
  ...
  return (
    ...
    >
      ...
      <div
        data-cy="planning-taskrow-connector-h"
      ...
      {isLast && (
        <div
          data-cy="planning-taskrow-connector-v-cover"
      ...
      {viewMode === 'reporting' && (
        <div
          data-cy="planning-taskrow-status-cell"
      ...
      {/* Task name */}
      <p
        data-cy="planning-taskrow-task-name"
      ...
      {/* Meta tags */}
      <div
        data-cy="planning-taskrow-meta"
        className="flex items-center gap-1.5 flex-shrink-0"
      >
        <div
          data-cy="planning-taskrow-priority-wrap"
