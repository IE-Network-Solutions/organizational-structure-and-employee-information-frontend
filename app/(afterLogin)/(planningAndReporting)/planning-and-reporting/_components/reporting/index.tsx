  ...
  return (
    ...
    >
      ...
      >
        {getReportLoading ? (
          <div
            data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-reporting-index-tsx-div-L184"
            className="space-y-4"
          >
            {[0, 1, 2].map((i) => (
          ...
          isMobile || isTablet ? (
            <div
              data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-reporting-index-tsx-div-L191"
              className="space-y-4"
            >
          ...
          >
            ...
            >
              <div
                data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-reporting-index-tsx-div-L271"
              ...
              <p
                data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-reporting-index-tsx-p-L284"
              ...
              <p
                data-cy="auto-app-afterlogin-planningandreporting-planning-and-reporting-components-reporting-index-tsx-p-L289"
