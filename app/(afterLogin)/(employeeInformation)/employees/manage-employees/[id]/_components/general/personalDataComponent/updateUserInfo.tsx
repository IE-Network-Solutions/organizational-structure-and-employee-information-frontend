...
import { useUpdateEmployeeInformation, useUpdateEmployee } from '@/store/server/features/employees/employeeDetail/mutations';
...
function UpdateUserInfo({ employeeData }: any) {
  ...
  const handleSaveChanges = (values: any) => {
    ...
    const employeeInfoFields = {
      ...
      joinedDate: values.joinedDate ? dayjs(values.joinedDate).format('YYYY-MM-DD') : null,
    };
