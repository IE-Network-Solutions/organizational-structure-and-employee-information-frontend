  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="py-2" id="certificate-tasks-section" data-cy="certificate-tasks-section">
          <h3
      ...
      >
        {/* Employee Name */}
        <div className="text-center py-1" id="certificate-employee-name-wrapper" data-cy="certificate-employee-name-wrapper">
          <p className="text-xs text-gray-600 mb-1" id="certificate-employee-prefix" data-cy="certificate-employee-prefix">
        ...
        <div className="text-center py-0" id="certificate-completion-text" data-cy="certificate-completion-text">
          <p className="text-sm font-bold text-gray-800 mb-0" id="certificate-completion-line" data-cy="certificate-completion-line">
            Successfully Completed these{' '}
            <span className="text-blue px-2 py-1 rounded" id="certificate-completion-line-span" data-cy="certificate-completion-line-span">
              Off Boarding Process&apos;s on
            </span>
          </p>
          <p className="text-xs text-gray-700" id="certificate-award-date" data-cy="certificate-award-date">
            Award Date: {currentDate}
          </p>
        </div>

        {/* Signature Section */}
        <div className="flex justify-between items-end space-x-6 mt-3" id="certificate-signature-row" data-cy="certificate-signature-row">
          <div className="flex-1 text-center" id="certificate-signature-block" data-cy="certificate-signature-block">
            <div className="border-b-2 border-gray-400 w-32 mx-auto mb-2 h-8" id="certificate-signature-block-divider" data-cy="certificate-signature-block-divider"></div>
            <p className="text-sm font-medium text-gray-700" id="certificate-signature-block-text" data-cy="certificate-signature-block-text">SIGNATURE</p>
          </div>
          <div className="flex-1 text-center" id="certificate-date-block" data-cy="certificate-date-block">
            <div className="border-b-2 border-gray-400 w-32 mx-auto mb-2 h-8 flex items-center justify-center" id="certificate-date-block-divider" data-cy="certificate-date-block-divider">
              <span className="text-sm text-gray-600" id="certificate-date-block-text" data-cy="certificate-date-block-text">{currentDate}</span>
            </div>
            <p className="text-sm font-medium text-gray-700" id="certificate-date-block-text" data-cy="certificate-date-block-text">DATE</p>
          </div>
          <div className="flex-1 text-center" id="certificate-stamp-block" data-cy="certificate-stamp-block">
            <div className="w-32 h-32 mx-auto mb-6 relative rounded-full overflow-hidden " id="certificate-stamp-block-image" data-cy="certificate-stamp-block-image">
              {tenantData?.stamp && (
                <Image
            ...
            <p className="text-sm font-medium text-gray-700" id="certificate-stamp-block-text" data-cy="certificate-stamp-block-text">COMPANY STAMP</p>
          </div>
        </div>
      </div>
    </div>
