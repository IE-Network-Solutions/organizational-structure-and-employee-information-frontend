import { Col, Form, Row, Select,Input, Steps, Upload } from 'antd'
...
const BankInformationForm=()=>{
  ...
  return (
    ...
    <div className='flex justify-center items-center text-gray-950 text-sm font-semibold my-2'>Bank Account</div>
      ...
      <AddCustomField formTitle='address' setNewValue={setBankInfoForm} customEmployeeInformationForm={bankInfoForm}/></Row>
    </div>
  )
}
