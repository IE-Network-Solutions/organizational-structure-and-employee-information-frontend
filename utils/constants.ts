...
export const TENANT_MGMT_URL = "https://test-api.ienetworks.co/tenant-backend/api/v1";
...
export const TIME_AND_ATTENDANCE_URL = 'https://test-api.ienetworks.co/time-attendance/api/v1';
