...
// Notification: NOTIFICATION_URL for REST; NEXT_PUBLIC_NOTIFICATION_WS_* for WebSocket (client). Push: NEXT_PUBLIC_VAPID_PUBLIC_KEY.
export const NOTIFICATION_URL = process.env.NOTIFICATION_URL;
export const NOTIFICATION_WS_URL = process.env.NEXT_PUBLIC_NOTIFICATION_WS_URL ?? '';
export const NOTIFICATION_WS_PATH =
  process.env.NEXT_PUBLIC_NOTIFICATION_WS_PATH ?? '/api/v1/notifications-ws';
