...
describe('Manage Your Employees - Inactive Users', () => {
    ...
    it('should click on the edit button and navigate to the edit page', () => {
      ...
      cy.url().should('include', '/employees/manage-employees/2690e9b0-c6a0-406c-9499-7848e1e9618a');
    });
    ...
    it('should edit Personal Info', () =>{
      ...
      cy.wait(5000);
      cy.url().should('include', '/employees/manage-employees/dd08c45e-2389-4008-9e67-29740fc23d32');
