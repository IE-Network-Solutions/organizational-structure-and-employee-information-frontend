        ...
        {userCoords ? (
          <>
            ...
            >
              ...
              >
                <EnvironmentOutlined className="shrink-0 text-[#ff4d4f]" />
                <span
                    ...
                    >
                      <div className="flex min-w-0 items-center gap-2">
                        ...
                        <div className="min-w-0">
                          <Text className="block truncate text-sm font-medium text-gray-900">
                            {summary.area.title}
                          </Text>
                          <Text className="block text-xs text-gray-500">
                            Radius:{' '}
                            {formatDistanceMeters(Number(summary.area.distance))}
            ...
            >
              <span className="inline-flex items-center gap-1.5">
                <span className="inline-block h-3 w-3 rounded-full bg-[#ff4d4f]" />
                You
              </span>
              <span className="inline-flex items-center gap-1.5">
                <span className="inline-block h-3 w-3 rounded-full border-2 border-[#3636F0] bg-[#3636F0]/20" />
                Allowed area radius
              </span>
            </div>
          </>
