  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeMiterlimit="10"
        strokeLinecap="round"
        data-cy="simple-logo-path-9"
      />
      <path fill="#111827" data-cy="simple-logo-path-10" />
    </svg>
  );
}
