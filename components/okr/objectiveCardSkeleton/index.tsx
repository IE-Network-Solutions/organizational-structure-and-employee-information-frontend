              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
                    ...
                    <div className="flex flex-shrink-0 items-center justify-end gap-3 sm:ml-auto">
                      {showAssignee ? (
                        <div
                          className="hidden sm:flex items-center gap-3"
                          data-cy={`okr-objective-card-skeleton-assignee-${idx}`}
                        >
                          <div className="h-10 w-10 rounded-full bg-gray-200 animate-pulse border border-gray-200" />
                  ...
                  <div className="divide-y divide-gray-200 bg-white">
                    {Array.from({ length: 3 }).map((__, rowIdx) => (
                      ...
                      >
                        ...
                        <ShimmerLine className="h-4 w-24" />
                        <ShimmerLine className="h-4 w-56" />
                        <div className="ml-auto h-6 w-6 rounded-[4px] border border-gray-200 bg-gray-50" />
                      </div>
                    ))}
                  </div>
                </div>
