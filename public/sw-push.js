          ...
          .then(function (data) {
            ...
            var id =
              dataObj.id != null
                ...
                : raw.id != null
                  ? String(raw.id)
                  : raw.notificationId != null
                    ? String(raw.notificationId)
                    : dataObj.notificationId != null
                      ? String(dataObj.notificationId)
                      : '';
            var baseUrl =
              dataObj.url != null
                ? String(dataObj.url)
            ...
            var opts = {
              ...
              badge: '/icons/192.png',
              tag: tag,
              data: { title: title, body: body, id: id, url: url },
  ...
  function showPushFallback(notifTitle, notifBody, notifUrl) {
    ...
    return self.registration
      .showNotification(notifTitle, {
        body: notifBody,
        tag: 'notification-fallback-' + Date.now(),
        data: { url: u },
        silent: false,
      })
      .then(null, function () {
