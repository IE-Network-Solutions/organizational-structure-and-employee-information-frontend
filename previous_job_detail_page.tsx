            ...
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                <span className="text-xs text-gray-500">
                  Last Analyzed GÇó {dayjs(matchResponse?.analysisTimestamp).fromNow()}
                </span>
              </div>
            </div>
                  ...
                  <div className="h-full flex flex-col">
                    ...
                    <div className="pb-4 border-b border-gray-200">
                      ...
                      <div className="mt-4 space-y-2 text-sm text-gray-700">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-gray-400">=ƒôP</span>
                          <span>
                  ...
                  <div className="flex-1 overflow-y-auto pt-4 space-y-6">
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-3">
                        <span className="text-gray-600">=ƒæñ</span>
                    ...
                    <div>
                      ...
                      <div className="pt-4">
                        <div className="flex items-center gap-2 mb-3">
                          <span className="text-gray-700">=ƒÆ+</span>
                          <span className="font-semibold text-gray-900">
                            Experience
                          </span>
                        </div>
                    ...
                    <div>
                      ...
                      <div className="pt-4">
                        <div className="flex items-center gap-2 mb-3">
                          <span className="text-gray-700">=ƒÄô</span>
                          <span className="font-semibold text-gray-900">
                            Education
                          </span>
                        </div>
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                              {visibleMatchedSkills.map((skill, idx) => (
                                ...
                                >
                                  <span className="text-green-600 text-xs">G£ô</span>
