...
3. Calculates proportional upgrade cost:
   ...
   **current_plan_cost_for_period = current_slot_price * subscription.slotTotal * current_planPeriod.periodMultiplier**

   **current_cost_for_remaining_days = current_plan_cost_for_period * period_share**

   **new_plan_cost_for_full_period = new_slot_price * subscription.slotTotal * new_planPeriod.periodMultiplier**
...
3. Calculates proportional cost of additional slots:
   ...
   **additional_slots_cost = slot_price * number_of_additional_slots * period_share**
...
3. System calculates extension cost:
   * If there is planned plan change:
     ...
     **extension_cost = slot_price * number_of_slots * new_planPeriod.periodMultiplier**
   * If no planned plan change:
     ...
     **extension_cost = slot_price * current_subscription.slotTotal * planPeriod.periodMultiplier**
