...
const getPermisssions = async () => {
   ...
   */
  export const useGetPermissions = ()=> useQuery<any[]>("posts" , getPermisssions)
   ...
   */
  export const useGetPermission =(postId:number)=> useQuery<any>(['post' , postId] , ()=> getPermission(postId) , {
