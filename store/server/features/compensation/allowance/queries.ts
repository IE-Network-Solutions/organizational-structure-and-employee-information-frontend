 ...
 */
const fetchAllowanceEntitlements = async (compensationId: string | string[]) => {
  ...
  return await crudRequest({
    url: `${PAYROLL_URL}/compensation-item-entitlement/compensation/${compensationId}`,
    method: 'GET',
    headers,
  });
};
 ...
 */
export const useFetchAllowanceEntitlements = (compensationId: string | string[]) => {
  return useQuery(['allowanceEntitlement'], () =>
    fetchAllowanceEntitlements(compensationId),
  );
}